            ...
            <div className="mt-12 bg-primary/5 border border-primary/20 p-8 rounded-3xl">
               ...
               <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-sm">
                  <div className="bg-black/40 p-5 rounded-xl border border-white/5">
                     <div className="text-primary font-bold mb-2 uppercase italic text-xs tracking-widest">1. Quan sát</div>
                     <p className="text-gray-400 text-[11px] italic">Nếu khuôn mặt quá mịn hoặc ánh sáng bóng loáng bất thường, hãy nghi ngờ ngay.</p>
                  </div>
                  <div className="bg-black/40 p-5 rounded-xl border border-white/5">
                     <div className="text-primary font-bold mb-2 uppercase italic text-xs tracking-widest">2. Thử thách</div>
                     <p className="text-gray-400 text-[11px] italic">Yêu cầu người gọi vẫy tay trước mặt. AI sẽ bị lỗi hiển thị khi có vật che.</p>
                  </div>
                  <div className="bg-black/40 p-5 rounded-xl border border-white/5">
                     <div className="text-primary font-bold mb-2 uppercase italic text-xs tracking-widest">3. Xác minh</div>
                     <p className="text-gray-400 text-[11px] italic">Gọi lại sim chính của người thân. Kẻ lừa đảo không thể nhận cuộc gọi GSM.</p>
                  </div>
               </div>
            </div>
        )}
    ...
    <div className="max-w-4xl mx-auto py-4 px-4 animate-in fade-in duration-500">
      ...
      <div className="space-y-6">
          ...
          <div className="bg-black/40 border border-white/5 p-6 rounded-2xl text-center italic text-gray-400 text-sm">
             <span className="text-primary font-bold">💡 {lang === 'vi' ? 'GỢI Ý QUAN SÁT:' : 'OBSERVATION HINT:'}</span> {lvl.hint}
          </div>
      </div>
    </div>
  );
